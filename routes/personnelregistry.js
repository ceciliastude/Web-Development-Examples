...
{    
    ...
    async function sqlQuery()
    {
        ...
        if(request.session.loggedin)
        {
            ...
            htmlOutput +="<div class=\"welcometext\" style=\"text-align: center;\">Personnel Registry</div>\n";
            htmlOutput += "<a href=\"http://localhost:3000/api/newemployee\" style=\"color:#336699;text-decoration:none; margin-left:1200px;\">Add new employee</a>";
            htmlOutput +="</table>";
        }
        else
        {
...
router.get('/:employeeid', function(request, response)
{
    ...
    async function sqlQuery()
    {
        ...
        "<div class=\"welcometext\" style=\"text-align: center;\">Personnel Registry - " + employeeid + "</div>\n" +
        "<table id=\"infomiddle\">\n"+
